...
(cl:defclass <GroupMotorInfo> (roslisp-msg-protocol:ros-message)
  ((motor_group
    :reader motor_group
    :initarg :motor_group
    :type (cl:vector epos_manager-msg:MotorInfo)
   :initform (cl:make-array 0 :element-type 'epos_manager-msg:MotorInfo :initial-element (cl:make-instance 'epos_manager-msg:MotorInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <GroupMotorInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GroupMotorInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name epos_manager-msg:<GroupMotorInfo> is deprecated: use epos_manager-msg:GroupMotorInfo instead.")))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <GroupMotorInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'motor_group)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'epos_manager-msg:MotorInfo))
