"""autogenerated by genpy from epos_manager/GroupEPOSControl.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct

import epos_manager.msg

class GroupEPOSControl(genpy.Message):
  _md5sum = "58778ccf9bb7db6f7ccd5eaa3d10b6d8"
  _type = "epos_manager/GroupEPOSControl"
...
"""
  ...
  _slot_types = ['epos_manager/EPOSControl[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = epos_manager.msg.EPOSControl()
        _x = val1
        start = end
        end += 7
