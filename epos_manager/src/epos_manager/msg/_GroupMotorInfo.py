"""autogenerated by genpy from epos_manager/GroupMotorInfo.msg. Do not edit."""
import sys
...
class GroupMotorInfo(genpy.Message):
  ...
  _type = "epos_manager/GroupMotorInfo"
...
"""
  ...
  _slot_types = ['epos_manager/MotorInfo[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = epos_manager.msg.MotorInfo()
        start = end
        end += 2
